    ...
    const fetchMenuItems = async () => {
      try {
        ...
        const response = await fetch(
          `https://flask-apidelivery.onrender.com/menus/restmenus/${restaurant_id}`,
          {
            method: "GET",
            headers: {
    ...
    <div className="parentcontainer">
      ...
      <div className="container">
        ...
        <p style={{ textAlign: "center" }}>
          Before you savor the delectable array of main courses, we invite you
          to indulge in our delightful selection of appetizers. Our culinary
          team has carefully curated these mouthwatering starters to awaken your
          taste buds and set the stage for an exceptional dining experience.
          From light and refreshing salads to savory small plates and
          irresistible finger
          </p>
      <p style={{ textAlign: "center" }}>
